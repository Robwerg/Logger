...
String project = "TST";
String siteID = "AA";
float raingaugeTip_mm = 1; //was 0.2
...
void loop () {
  ...
  if (battVoltUpdate() < 3.3) { // If battery less that 3.5v, sleep and reset via wdt
...
void OneWireTempSetup() {
  ...
  delay(1000);  //Wait till we are warmed up
